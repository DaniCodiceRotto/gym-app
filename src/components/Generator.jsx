...
export default function Generator(props) {
    ...
    return (
        <SectionWrapper id={'generate'} header={"generate your workout "} title={['It\'s', 'Huge', 'o\'clock']}>
            <Header index={'01'} title={'Pick Your Poison '} description={"Select The Workout u Want To Enjoy"} />
            ...
            <Header index={'02'} title={'Lock On Target '} description={"Select The Muscle chosen for Annihilation"} />
